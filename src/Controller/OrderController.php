...
class OrderController extends AbstractController
{
     ...
     */
    public function showCount(OrderItem $item, OrderService $orderService, Request $request)
    {
        $cartTable=  $this->setCount($item, $orderService, $request);
        $h_c=$this->headerCart($orderService);
        return $this->json(['cartTable' => $cartTable, 'headerCart' => $h_c]);
